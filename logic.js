...
showAllPlants = (data) => {
    ...
    data.forEach((element) => {
        ...
        <div class="card bg-base-100 shadow-sm">
            <figure>
                <img src="${element.image}" alt="" class="w-[316px] h-[180px] object-cover rounded-sm" loading="lazy"/>
            </figure>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="card-actions justify-end">
                        <button id="plant-id-${element.id}"
                            class="btn bg-[#15803D] text-white w-full rounded-full mt-4 hover:bg-[#3C8A5A]">Add toCart
                        </button>
                    </div>
                </div>
            </div>
